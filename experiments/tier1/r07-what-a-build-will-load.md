...
abiflags: ''
gil disabled: 0
soabi: cpython-315-aarch64-linux-gnu
...
what the finder does with one file of each kind
  demo.cpython-315-aarch64-linux-gnu.so    considered
  demo.cpython-315t-aarch64-linux-gnu.so   invisible, the name is wrong
  demo.cpython-999-aarch64-linux-gnu.so    invisible, the name is wrong
