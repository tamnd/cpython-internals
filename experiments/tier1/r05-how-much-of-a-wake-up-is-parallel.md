# Four threads reaching for four different deferred imports, with the lock on
...
Why this needs the release build: it needs several processors and a quiet machine, because the answer is a ratio of processor time to wall clock and both halves of that move when something else runs.
